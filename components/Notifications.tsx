...
const Notifications = () => {
    ...
    // filter out the unread notifications, using the readAt property
    const unreadNotifications = inboxNotifications.filter(notification => !notification.readAt);

    return (
        <Popover>
            <PopoverTrigger className='relative flex size-10 justify-center items-center cursor-pointer rounded-lg'>
                <Image
